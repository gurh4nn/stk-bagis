...
function AddCorpotationVergi() {
    ...
    return (
        ...
        <form action="" onSubmit={(e) => {
           ...
           <textarea style={{height: "80px"}} type="text" name="vergi_content" id="desc" placeholder="Description Giriniz" value={corpotationAdd.vergi_content}  onChange={handleChange} />
           <input type="text" name="vergi_img" id="image" placeholder="Görsel Adresini Giriniz" value={corpotationAdd.vergi_img}  onChange={handleChange} />
...
export default AddCorpotationVergi
